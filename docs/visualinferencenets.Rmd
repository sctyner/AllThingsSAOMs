# Visual Inference for Stochastic Actor Oriented Models {#ch2}
...
```{r smallfriends, echo=FALSE, fig.width=8, fig.height=3, message = FALSE, warning = FALSE, fig.cap="Adjacency matrices describing friendship relations between 50 students in waves 1,2, and 3 of the friendship study of \\@friendsdata. The red squares identify the subset we focus on for our experiment."}
