...
actual1$X1 <- paste0("V", actual1$X1)
actual1$X2 <- ifelse(is.na(actual1$X2), actual1$X2, paste0("V",actual1$X2))
ggplot(data = actual1, aes(from_id = X1, to_id = X2)) + 
  geom_net(labelon = TRUE, hjust = 0.5, vjust=0.5, size=10,  
...
exlu$from <- paste0("V", exlu$from)
exlu$to <- ifelse(is.na(exlu$to),exlu$to,paste0("V", exlu$to))
ggplot(data = exlu) + 
