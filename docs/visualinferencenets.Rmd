...
\begin{figure}
\centering
```{r wave1, echo=FALSE, message=FALSE, warning=FALSE, fig.height=5, out.width='.6\\linewidth', fig.cap="Network of friendships of wave 1 of the subset of students marked in Figure \\@ref(smallfriends)."}
library(sna)
library(network)
...
For model $M_2$, parameter $\beta_3$ is estimated to be significantly different from zero in \Sexpr{round(100 * beta3sig10, 1)}\% of cases. This coincides with our expectation.
...
\textbf{Gender:} \\
```{r tab_demo, echo=FALSE, results='asis'}
...
```{r tab_demo3, echo=FALSE, results='asis'}
...
\centering
\textbf{Age Group:} \\
```{r tab_demo2, echo=FALSE, results='asis'}
