...
2. Using definitions from previous slides:
    $$\alpha_m^{C_m} \prod_{c=1}^{C_m} \frac{\exp\left\{f_{i_c}(\boldsymbol{\beta}, X(T_{c}), \mathbf{Z})\right\}}{\sum_{X'(T_c) \in \mathcal{A}(X(T_{c-1})) j_c}\exp\left\{f_{i_c}(\boldsymbol{\beta}, X'(T_{c}))\right\}}$$
