...
## Results 1
``` {r, echo=FALSE, fig.align = 'center', out.width = '100%',fig.height=5}
...
- People pick out plots with high number of JTTs. 


## Next Steps

- What other structures stand out?
- What parameters make noticeable differences in structure?
...
# Next Steps: Removing the Blindfold
...
- 1000 simulations from a fitted network model. 
